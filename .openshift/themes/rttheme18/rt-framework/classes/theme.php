...
class RTThemeSite extends RTTheme {
	...
	function load_scripts(){
		...
		wp_enqueue_script('aboutUs', RT_THEMEURI  . '/js/aboutUs.js', array('jquery') , "", "true" );	 
	...
	function load_styles(){ 
        ...
        #windy
        wp_register_style('windy', RT_THEMEURI . '/css/windy.css');
        #THDK
        wp_register_style('remarkable-styles-update', RT_THEMEURI . '/css/remarkable-styles-update.css');
        #END THDK
        #HL
        wp_register_style('aboutUs', RT_THEMEURI . '/css/aboutUs.css');        
        wp_register_style('font-awesome', RT_THEMEURI . '/css/font-awesome.css');
        wp_register_style('contactUs', RT_THEMEURI . '/css/contactUs.css');
        wp_register_style('academy', RT_THEMEURI . '/css/academy.css');
        
        
        #HL
        wp_enqueue_style('aboutUs');
		wp_enqueue_style('contactUs');
		wp_enqueue_style('academy');
        ...
        #windy
        wp_enqueue_style('windy');

        wp_register_style('remarkable-styles', RT_THEMEURI . '/css/remarkable-styles.css');
        wp_enqueue_style('remarkable-styles');
        wp_enqueue_style('remarkable-styles-update');
