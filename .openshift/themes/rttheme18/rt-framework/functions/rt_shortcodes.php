...
if( ! function_exists("rt_content_box") ){
	...
	*/
	...
	//final output
	$output=""; 
	$output.='<article id="'.$id.'" class="featured" data-rt-animate="animate" data-rt-animation-type="fadeIn" data-rt-animation-group="content_box">' .$caption_output;
...
if( ! function_exists("rt_content_icon_box") ){
	...
	*/
	...
	//final output
	$output="";
	$output.='<article id="'.$id.'" class="featured" data-rt-animate="animate" data-rt-animation-type="fadeInDown" data-rt-animation-group="content_icon_box">' .$caption_output;
	$output.= $text.''.$link_output;
	$output.='</article>'; 
...
if( ! function_exists("rt_h_chained_contents") ){
	...
	*/
	...
	//output
	$output=""; 
	$output.='<ul id="'.$id.'" class="horizontal_chained_contents">';
...
if( ! function_exists("rt_h_content") ){
	...
	*/
	...
	//output
	$output = sprintf('<li id="%1$s" data-rt-animate="animate" data-rt-animation-type="fadeInDown" data-rt-animation-group="content_box"> %2$s %3$s</li>',$id, $image_section, $content_section );	
...
if( ! function_exists("rt_v_chained_media_boxes") ){
	...
	*/
	...
	//output
	$output=""; 
	$output.='<section id="'.$id.'" class="chained_contents '.$image_align_class.'"><ul>';
	$output.= do_shortcode( $content );
	$output.='</ul></section>'; 
...
if( ! function_exists("rt_v_media_box") ){
	...
	*/
	...
	//output
	$output = sprintf('<li data-rt-animate="animate" data-rt-animation-type="fadeInDown" data-rt-animation-group="content_box">%1$s %2$s</li>',$image_section, $content_section );	
...
if( ! function_exists("rt_v_chained_icon_boxes") ){
	...
	*/
	...
	//output
	$output=""; 
	$output.='<section id="'.$id.'" class="chained_contents icon_chain '.$icon_align_class.'"><ul>';
	$output.= do_shortcode( $content );
	$output.='</ul></section>'; 
...
if( ! function_exists("rt_v_icon_box") ){
	...
	*/
	...
	//output
	$output = sprintf('<li data-rt-animate="animate" data-rt-animation-type="fadeInDown" data-rt-animation-group="content_box">%1$s %2$s</li>', $icon_section, $content_section );	
...
if( ! function_exists("rt_text_box") ){
	...
	*/
	...
	//final output
	$output="";
	$output.='<section id="'.$id.'" class="text_box" data-rt-animate="animate" data-rt-animation-type="fadeIn" data-rt-animation-group="text_box">';
	$output.= $text;
	$output.='</section>'; 
...
if( ! function_exists("rt_horizontal_line") ){
	...
	$horizontal_line = '<hr class="style-'.$styles[$style].' margin-t'.$margin_top.' margin-b'.$margin_bottom.' "  data-rt-animate="animate" data-rt-animation-type="fadeInDown" data-rt-animation-group="horizontal_line" >';	 
...
if( ! function_exists("rt_portfolio") ){
	...
	echo '<div id="'.$id.'" class="portfolio_holder clearfix '.$add_holder_class.' " data-rt-animate="animate" data-rt-animation-type="fadeIn" data-rt-animation-group="portfolio_item">';
...
if( ! function_exists("rt_products") ){
	...
	echo '<div class="product_boxes">';
		...
		while ( $theQuery->have_posts() ) : $theQuery->the_post();
			...
			printf('<div class="box %s %s %s %s %s"><div class="product_item_holder" data-rt-animate="animate" data-rt-animation-type="fadeIn" data-rt-animation-group="product_item">'."\n",$layout_values[$item_width],$add_class,$first_row,$last_row,$addTermsClass);
...
if( ! function_exists("rt_products_carousel") ){
	...
	echo '<div id="'.$id.'" class="carousel-holder clearfix '.$add_holder_class.' ">';
 
	echo '<section class="carousel_items"><div class="owl-carousel">';

		while ( have_posts() ) : the_post();

			echo '<div class="product_item_holder item" data-rt-animate="animate" data-rt-animation-type="fadeIn" data-rt-animation-group="product_carousel">'."\n";
...
if( ! function_exists("rt_portfolio_carousel") ){
	...
	echo '<section class="carousel_items clearfix"><div class="owl-carousel">';
		...
		while ( have_posts() ) : the_post();
			...
			echo '<div class="item" data-rt-animate="animate" data-rt-animation-type="fadeIn" data-rt-animation-group="portfolio_carousel">'."\n";
				//get post format
...
if( ! function_exists("rt_blogs_carousel") ){
	...
	echo '<section class="latest-news carousel_items clearfix"><div class="owl-carousel">';
		...
		while ( have_posts() ) : the_post();
			...
			echo '<div class="item" data-rt-animate="animate" data-rt-animation-type="fadeIn" data-rt-animation-group="product_carousel">'."\n";
				//get blog content
...
if( ! function_exists("rt_staff") ){
	...
	echo '<section id="'.$id.'" class="team clearfix '.$add_holder_class.' ">';
		...
		while ( have_posts() ) : the_post();
			...
			printf('<div class="person box %s %s" data-rt-animate="animate" data-rt-animation-type="fadeInDown" data-rt-animation-group="staff_box">'."\n",$layout_values[$item_width],$add_class);
...
if( ! function_exists("rt_testimonials") ){
	...
	echo '<section id="'.$id.'" class="testimonials clearfix '.$add_holder_class.' ">';
		...
		while ( have_posts() ) : the_post();
			...
			printf('<div class="testimonial box %s %s" data-rt-animate="animate" data-rt-animation-type="fadeIn" data-rt-animation-group="testimonial_box">'."\n",$layout_values[$item_width],$add_class);
...
if( ! function_exists("rt_testimonial_carousel") ){
	...
	echo '<section class="carousel_items clearfix" data-rt-animate="animate" data-rt-animation-type="fadeIn" data-rt-animation-group="testimonial_carousel"><div class="owl-carousel">';
...
if( ! function_exists("rt_photo_gallery") ){
	...
	$rt_photo_gallery='<div class="row clearfix"><ul class="photo_gallery shortcode ">';
...
if( ! function_exists("rt_photo_gallery_lines") ){
	...
	$items_output .= sprintf('
		<li class="box %s" data-rt-animate="animate" data-rt-animation-type="fadeIn" data-rt-animation-group="product_carousel">
			<div class="%s">	
				%s							
				<img src="%s" alt="%s"> 									
			</div>
...
if( ! function_exists("rt_shortcode_contact_form") ){
	...
	$contact_form .= "".
		...
		'			<input type="submit" class="button send_contact" value="'.__('Send','rt_theme').'"  /><span class="loading"></span></li>'.
		'		</ul>'.
		'	</form>'.
...
if( ! function_exists("rt_icon_list_line") ){
	...
	$output = ' <li class="box '.$add_class.'" data-rt-animate="animate" data-rt-animation-type="fadeInDown" data-rt-animation-group="icon_list_line">'. $icon_output .' <p>' . stripcslashes( $content ) . '</p></li>';
...
if( ! function_exists("rt_shortcode_tabs") ){
	...
	return '<div class="shortcode_tabs '.$tabs_style.'" data-rt-animate="animate" data-rt-animation-type="fadeIn" data-rt-animation-group="tabs"><div class="tabs_wrap"><ul class="tabs clearfix">'.$tabs.'</ul><div class="panes">'.$content.'</div></div></div>';
	}
}
...
if( ! function_exists("rt_shortcode_accordion_panel") ){
	...
	$panes  = ""; 
	$panes .= ($rt_accordion_first_open && $rt_accordion_number_count==1) ? '<li class="open" data-rt-animate="animate" data-rt-animation-type="fadeInDown" data-rt-animation-group="accordion">': '<li data-rt-animate="animate" data-rt-animation-type="fadeInDown" data-rt-animation-group="accordion">'; 
...
if( ! function_exists("rt_shortcode_button") ){
	...
	//button format
	$button_format = '<a href="%s" target="%s" title="%s" class="button_ %s %s %s margin-t%s align%s" data-rt-animate="animate" data-rt-animation-type="bounceIn" data-rt-animation-group="button" >%s</a>';
...
if( ! function_exists("rt_shortcode_banner") ){
	...
	#
		...
		if( $text_alignment == "left"){
			$banner_format = '
				<div id="%1$s" class="banner %9$s %10$s clearfix" data-rt-animate="animate" data-rt-animation-type="fadeIn" data-rt-animation-group="banner" >
				%8$s
...
if( ! function_exists("rt_heading_bar") ){
	...
	if ( empty( $style ) ){
		$heading_output = ! empty( $heading ) ? sprintf('<div class="title_line margin-b20"><h3 class="featured_article_title" data-rt-animate="animate" data-rt-animation-type="fade" data-rt-animation-group="heading_bar">%s %s</h3></div>',$icon_output, $heading) : "";
	}else{
		$heading_output = ! empty( $heading ) ? sprintf('<h3 class="featured_article_title heading-%s" data-rt-animate="animate" data-rt-animation-type="fade" data-rt-animation-group="heading_bar">%s %s</h3>',$style, $icon_output, $heading) : "";
	}
...
if( ! function_exists("rt_space_box") ){
	...
	$output = ! empty( $id ) ? sprintf('<div id="%s" class="clearfix"></div>', $id) : "";
...
if( ! function_exists("rt_table_holder") ){
	...
	$output = '<div class="pricing_table '.$style.'">'; 
...
if( ! function_exists("rt_table_columns") ){
	...
	$output = '<div class="table_wrap '.$style.'" data-rt-animate="animate" data-rt-animation-type="fadeInDown" data-rt-animation-group="tables"><ul>';	 
...
if( ! function_exists("rt_info_box") ){
	...
	$output = sprintf('
		<div class="info_box margin-b20 clearfix %s">
