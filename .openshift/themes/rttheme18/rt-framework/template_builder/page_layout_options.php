		...
		foreach($template_contents as $item_num => $template){ 
			...
			elseif( $content_type == "testimonial_box" ){
			 	...
			 	*/
 				...
 				$template_output .=  sprintf('[testimonial_box id="%s" item_width="%s" list_orderby="%s" list_order="%s" style="%s" ids="%s"]',
 					$testimonial_box_id, $item_width, $list_orderby, $list_order, $style, $testimonial_ids) ; 
